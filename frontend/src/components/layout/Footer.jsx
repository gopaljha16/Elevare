...
const Footer = ({ className }) => {
  ...
  return (
    <footer className={cn("bg-gray-900 dark:bg-gray-950 text-white", className)}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              The AI-powered career platform that helps you build resumes, prepare for interviews, and land your dream job with personalized insights and guidance.
            </motion.p>
          ...
          {Object.entries(footerLinks).map(([category, links], categoryIndex) => (
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h4 className="font-semibold mb-6 text-lg capitalize">{category}</h4>
